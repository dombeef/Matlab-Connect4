...
% Date: 5/13/17
% 
% PURPOSE: Connect 4, should be simple enough. Modified from my Connect 4 baseline
% code to prove how modular that code hopefully is
...
%           of bounds
            while  checkvalidmove(addcol, gamestate) == false
                clc
...
%           add player 1's move to the board
            gamestate = placemove(addcol, gamestate, 1);
...
%           adds player 2's move to the board
            gamestate = placemove(addcol, gamestate, 2);
